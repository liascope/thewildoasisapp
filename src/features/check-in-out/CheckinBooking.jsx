...
function CheckinBooking() {
  ...
  const { id: bookingId, guests, totalPrice, numberGuests, hasBreakfast, numberNights } = booking;

  const optionalBreakfastPrice = settings.breakfastPrice * numberNights * numberGuests;
